/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7299275d2451b5baa62903ff2259c1ed)
// Runtime types generated with workerd@1.20250813.0 2025-05-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		POLYMARKET_KEY: string;
		POLYMARKET_FUNDER: string;
		MY_CONTAINER: DurableObjectNamespace<import("./src/wrangler").MyContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POLYMARKET_KEY" | "POLYMARKET_FUNDER">> {}
}
