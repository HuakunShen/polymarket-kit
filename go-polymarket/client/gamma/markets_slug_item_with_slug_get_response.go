...
type MarketsSlugItemWithSlugGetResponse struct {
    // The active property
    active *bool
    ...
    description *string
    // The events property
    events []MarketsSlugItemWithSlugGetResponse_eventsable
...
// NewMarketsSlugItemWithSlugGetResponse instantiates a new MarketsSlugItemWithSlugGetResponse and sets the default values.
func NewMarketsSlugItemWithSlugGetResponse()(*MarketsSlugItemWithSlugGetResponse) {
    m := &MarketsSlugItemWithSlugGetResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateMarketsSlugItemWithSlugGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateMarketsSlugItemWithSlugGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewMarketsSlugItemWithSlugGetResponse(), nil
}
// GetActive gets the active property value. The active property
// returns a *bool when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetActive()(*bool) {
    return m.active
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetClobTokenIds gets the clobTokenIds property value. The clobTokenIds property
// returns a []string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetClobTokenIds()([]string) {
    return m.clobTokenIds
}
// GetClosed gets the closed property value. The closed property
// returns a *bool when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetClosed()(*bool) {
    return m.closed
}
// GetConditionId gets the conditionId property value. The conditionId property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetConditionId()(*string) {
    return m.conditionId
}
// GetDescription gets the description property value. The description property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetDescription()(*string) {
    return m.description
}
// GetEvents gets the events property value. The events property
// returns a []MarketsSlugItemWithSlugGetResponse_eventsable when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetEvents()([]MarketsSlugItemWithSlugGetResponse_eventsable) {
    return m.events
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["events"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateMarketsSlugItemWithSlugGetResponse_eventsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]MarketsSlugItemWithSlugGetResponse_eventsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(MarketsSlugItemWithSlugGetResponse_eventsable)
                }
            }
            m.SetEvents(res)
        }
...
// returns a *bool when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetHasReviewedDates()(*bool) {
    return m.hasReviewedDates
}
// GetIcon gets the icon property value. The icon property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetIcon()(*string) {
    return m.icon
}
// GetId gets the id property value. The id property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetId()(*string) {
    return m.id
}
// GetImage gets the image property value. The image property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetImage()(*string) {
    return m.image
}
// GetLiquidity gets the liquidity property value. The liquidity property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetLiquidity()(*string) {
    return m.liquidity
}
// GetLiquidityNum gets the liquidityNum property value. The liquidityNum property
// returns a *float64 when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetLiquidityNum()(*float64) {
    return m.liquidityNum
}
// GetNew gets the new property value. The new property
// returns a *bool when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetNew()(*bool) {
    return m.new
}
// GetOutcomePrices gets the outcomePrices property value. The outcomePrices property
// returns a []string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetOutcomePrices()([]string) {
    return m.outcomePrices
}
// GetOutcomes gets the outcomes property value. The outcomes property
// returns a []string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetOutcomes()([]string) {
    return m.outcomes
}
// GetQuestion gets the question property value. The question property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetQuestion()(*string) {
    return m.question
}
// GetQuestionID gets the questionID property value. The questionID property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetQuestionID()(*string) {
    return m.questionID
}
// GetSlug gets the slug property value. The slug property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetSlug()(*string) {
    return m.slug
}
// GetStartDate gets the startDate property value. The startDate property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetStartDate()(*string) {
    return m.startDate
}
// GetStartDateIso gets the startDateIso property value. The startDateIso property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetStartDateIso()(*string) {
    return m.startDateIso
}
// GetVolume gets the volume property value. The volume property
// returns a *string when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetVolume()(*string) {
    return m.volume
}
// GetVolume1mo gets the volume1mo property value. The volume1mo property
// returns a *float64 when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetVolume1mo()(*float64) {
    return m.volume1mo
}
// GetVolume1wk gets the volume1wk property value. The volume1wk property
// returns a *float64 when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetVolume1wk()(*float64) {
    return m.volume1wk
}
// GetVolume1yr gets the volume1yr property value. The volume1yr property
// returns a *float64 when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetVolume1yr()(*float64) {
    return m.volume1yr
}
// GetVolume24hr gets the volume24hr property value. The volume24hr property
// returns a *float64 when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetVolume24hr()(*float64) {
    return m.volume24hr
}
// GetVolumeNum gets the volumeNum property value. The volumeNum property
// returns a *float64 when successful
func (m *MarketsSlugItemWithSlugGetResponse) GetVolumeNum()(*float64) {
    return m.volumeNum
}
// Serialize serializes information the current object
func (m *MarketsSlugItemWithSlugGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *MarketsSlugItemWithSlugGetResponse) SetActive(value *bool)() {
    m.active = value
}
// SetAdditionalData sets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *MarketsSlugItemWithSlugGetResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetClobTokenIds sets the clobTokenIds property value. The clobTokenIds property
func (m *MarketsSlugItemWithSlugGetResponse) SetClobTokenIds(value []string)() {
    m.clobTokenIds = value
}
// SetClosed sets the closed property value. The closed property
func (m *MarketsSlugItemWithSlugGetResponse) SetClosed(value *bool)() {
    m.closed = value
}
// SetConditionId sets the conditionId property value. The conditionId property
func (m *MarketsSlugItemWithSlugGetResponse) SetConditionId(value *string)() {
    m.conditionId = value
}
// SetDescription sets the description property value. The description property
func (m *MarketsSlugItemWithSlugGetResponse) SetDescription(value *string)() {
    m.description = value
}
// SetEvents sets the events property value. The events property
func (m *MarketsSlugItemWithSlugGetResponse) SetEvents(value []MarketsSlugItemWithSlugGetResponse_eventsable)() {
    m.events = value
}
// SetHasReviewedDates sets the hasReviewedDates property value. The hasReviewedDates property
func (m *MarketsSlugItemWithSlugGetResponse) SetHasReviewedDates(value *bool)() {
    m.hasReviewedDates = value
}
// SetIcon sets the icon property value. The icon property
func (m *MarketsSlugItemWithSlugGetResponse) SetIcon(value *string)() {
    m.icon = value
}
// SetId sets the id property value. The id property
func (m *MarketsSlugItemWithSlugGetResponse) SetId(value *string)() {
    m.id = value
}
// SetImage sets the image property value. The image property
func (m *MarketsSlugItemWithSlugGetResponse) SetImage(value *string)() {
    m.image = value
}
// SetLiquidity sets the liquidity property value. The liquidity property
func (m *MarketsSlugItemWithSlugGetResponse) SetLiquidity(value *string)() {
    m.liquidity = value
}
// SetLiquidityNum sets the liquidityNum property value. The liquidityNum property
func (m *MarketsSlugItemWithSlugGetResponse) SetLiquidityNum(value *float64)() {
    m.liquidityNum = value
}
// SetNew sets the new property value. The new property
func (m *MarketsSlugItemWithSlugGetResponse) SetNew(value *bool)() {
    m.new = value
}
// SetOutcomePrices sets the outcomePrices property value. The outcomePrices property
func (m *MarketsSlugItemWithSlugGetResponse) SetOutcomePrices(value []string)() {
    m.outcomePrices = value
}
// SetOutcomes sets the outcomes property value. The outcomes property
func (m *MarketsSlugItemWithSlugGetResponse) SetOutcomes(value []string)() {
    m.outcomes = value
}
// SetQuestion sets the question property value. The question property
func (m *MarketsSlugItemWithSlugGetResponse) SetQuestion(value *string)() {
    m.question = value
}
// SetQuestionID sets the questionID property value. The questionID property
func (m *MarketsSlugItemWithSlugGetResponse) SetQuestionID(value *string)() {
    m.questionID = value
}
// SetSlug sets the slug property value. The slug property
func (m *MarketsSlugItemWithSlugGetResponse) SetSlug(value *string)() {
    m.slug = value
}
// SetStartDate sets the startDate property value. The startDate property
func (m *MarketsSlugItemWithSlugGetResponse) SetStartDate(value *string)() {
    m.startDate = value
}
// SetStartDateIso sets the startDateIso property value. The startDateIso property
func (m *MarketsSlugItemWithSlugGetResponse) SetStartDateIso(value *string)() {
    m.startDateIso = value
}
// SetVolume sets the volume property value. The volume property
func (m *MarketsSlugItemWithSlugGetResponse) SetVolume(value *string)() {
    m.volume = value
}
// SetVolume1mo sets the volume1mo property value. The volume1mo property
func (m *MarketsSlugItemWithSlugGetResponse) SetVolume1mo(value *float64)() {
    m.volume1mo = value
}
// SetVolume1wk sets the volume1wk property value. The volume1wk property
func (m *MarketsSlugItemWithSlugGetResponse) SetVolume1wk(value *float64)() {
    m.volume1wk = value
}
// SetVolume1yr sets the volume1yr property value. The volume1yr property
func (m *MarketsSlugItemWithSlugGetResponse) SetVolume1yr(value *float64)() {
    m.volume1yr = value
}
// SetVolume24hr sets the volume24hr property value. The volume24hr property
func (m *MarketsSlugItemWithSlugGetResponse) SetVolume24hr(value *float64)() {
    m.volume24hr = value
}
// SetVolumeNum sets the volumeNum property value. The volumeNum property
func (m *MarketsSlugItemWithSlugGetResponse) SetVolumeNum(value *float64)() {
    m.volumeNum = value
}
type MarketsSlugItemWithSlugGetResponseable interface {
    ...
    GetEvents()([]MarketsSlugItemWithSlugGetResponse_eventsable)
    ...
    SetEvents(value []MarketsSlugItemWithSlugGetResponse_eventsable)()
