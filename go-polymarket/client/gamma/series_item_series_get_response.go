...
type SeriesItemSeriesGetResponse struct {
    // The active property
    active *bool
...
// NewSeriesItemSeriesGetResponse instantiates a new SeriesItemSeriesGetResponse and sets the default values.
func NewSeriesItemSeriesGetResponse()(*SeriesItemSeriesGetResponse) {
    m := &SeriesItemSeriesGetResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateSeriesItemSeriesGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateSeriesItemSeriesGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewSeriesItemSeriesGetResponse(), nil
}
// GetActive gets the active property value. The active property
// returns a *bool when successful
func (m *SeriesItemSeriesGetResponse) GetActive()(*bool) {
    return m.active
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *SeriesItemSeriesGetResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetArchived gets the archived property value. The archived property
// returns a *bool when successful
func (m *SeriesItemSeriesGetResponse) GetArchived()(*bool) {
    return m.archived
}
// GetCgAssetName gets the cgAssetName property value. The cgAssetName property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetCgAssetName()(*string) {
    return m.cgAssetName
}
// GetClosed gets the closed property value. The closed property
// returns a *bool when successful
func (m *SeriesItemSeriesGetResponse) GetClosed()(*bool) {
    return m.closed
}
// GetCommentCount gets the commentCount property value. The commentCount property
// returns a *float64 when successful
func (m *SeriesItemSeriesGetResponse) GetCommentCount()(*float64) {
    return m.commentCount
}
// GetCompetitive gets the competitive property value. The competitive property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetCompetitive()(*string) {
    return m.competitive
}
// GetCreatedAt gets the createdAt property value. The createdAt property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetCreatedAt()(*string) {
    return m.createdAt
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *SeriesItemSeriesGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetIcon()(*string) {
    return m.icon
}
// GetId gets the id property value. The id property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetId()(*string) {
    return m.id
}
// GetImage gets the image property value. The image property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetImage()(*string) {
    return m.image
}
// GetLiquidity gets the liquidity property value. The liquidity property
// returns a *float64 when successful
func (m *SeriesItemSeriesGetResponse) GetLiquidity()(*float64) {
    return m.liquidity
}
// GetPythTokenID gets the pythTokenID property value. The pythTokenID property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetPythTokenID()(*string) {
    return m.pythTokenID
}
// GetRecurrence gets the recurrence property value. The recurrence property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetRecurrence()(*string) {
    return m.recurrence
}
// GetSeriesType gets the seriesType property value. The seriesType property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetSeriesType()(*string) {
    return m.seriesType
}
// GetSlug gets the slug property value. The slug property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetSlug()(*string) {
    return m.slug
}
// GetStartDate gets the startDate property value. The startDate property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetStartDate()(*string) {
    return m.startDate
}
// GetSubtitle gets the subtitle property value. The subtitle property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetSubtitle()(*string) {
    return m.subtitle
}
// GetTicker gets the ticker property value. The ticker property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetTicker()(*string) {
    return m.ticker
}
// GetTitle gets the title property value. The title property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetTitle()(*string) {
    return m.title
}
// GetUpdatedAt gets the updatedAt property value. The updatedAt property
// returns a *string when successful
func (m *SeriesItemSeriesGetResponse) GetUpdatedAt()(*string) {
    return m.updatedAt
}
// GetVolume gets the volume property value. The volume property
// returns a *float64 when successful
func (m *SeriesItemSeriesGetResponse) GetVolume()(*float64) {
    return m.volume
}
// GetVolume24hr gets the volume24hr property value. The volume24hr property
// returns a *float64 when successful
func (m *SeriesItemSeriesGetResponse) GetVolume24hr()(*float64) {
    return m.volume24hr
}
// Serialize serializes information the current object
func (m *SeriesItemSeriesGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *SeriesItemSeriesGetResponse) SetActive(value *bool)() {
    m.active = value
}
// SetAdditionalData sets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *SeriesItemSeriesGetResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetArchived sets the archived property value. The archived property
func (m *SeriesItemSeriesGetResponse) SetArchived(value *bool)() {
    m.archived = value
}
// SetCgAssetName sets the cgAssetName property value. The cgAssetName property
func (m *SeriesItemSeriesGetResponse) SetCgAssetName(value *string)() {
    m.cgAssetName = value
}
// SetClosed sets the closed property value. The closed property
func (m *SeriesItemSeriesGetResponse) SetClosed(value *bool)() {
    m.closed = value
}
// SetCommentCount sets the commentCount property value. The commentCount property
func (m *SeriesItemSeriesGetResponse) SetCommentCount(value *float64)() {
    m.commentCount = value
}
// SetCompetitive sets the competitive property value. The competitive property
func (m *SeriesItemSeriesGetResponse) SetCompetitive(value *string)() {
    m.competitive = value
}
// SetCreatedAt sets the createdAt property value. The createdAt property
func (m *SeriesItemSeriesGetResponse) SetCreatedAt(value *string)() {
    m.createdAt = value
}
// SetIcon sets the icon property value. The icon property
func (m *SeriesItemSeriesGetResponse) SetIcon(value *string)() {
    m.icon = value
}
// SetId sets the id property value. The id property
func (m *SeriesItemSeriesGetResponse) SetId(value *string)() {
    m.id = value
}
// SetImage sets the image property value. The image property
func (m *SeriesItemSeriesGetResponse) SetImage(value *string)() {
    m.image = value
}
// SetLiquidity sets the liquidity property value. The liquidity property
func (m *SeriesItemSeriesGetResponse) SetLiquidity(value *float64)() {
    m.liquidity = value
}
// SetPythTokenID sets the pythTokenID property value. The pythTokenID property
func (m *SeriesItemSeriesGetResponse) SetPythTokenID(value *string)() {
    m.pythTokenID = value
}
// SetRecurrence sets the recurrence property value. The recurrence property
func (m *SeriesItemSeriesGetResponse) SetRecurrence(value *string)() {
    m.recurrence = value
}
// SetSeriesType sets the seriesType property value. The seriesType property
func (m *SeriesItemSeriesGetResponse) SetSeriesType(value *string)() {
    m.seriesType = value
}
// SetSlug sets the slug property value. The slug property
func (m *SeriesItemSeriesGetResponse) SetSlug(value *string)() {
    m.slug = value
}
// SetStartDate sets the startDate property value. The startDate property
func (m *SeriesItemSeriesGetResponse) SetStartDate(value *string)() {
    m.startDate = value
}
// SetSubtitle sets the subtitle property value. The subtitle property
func (m *SeriesItemSeriesGetResponse) SetSubtitle(value *string)() {
    m.subtitle = value
}
// SetTicker sets the ticker property value. The ticker property
func (m *SeriesItemSeriesGetResponse) SetTicker(value *string)() {
    m.ticker = value
}
// SetTitle sets the title property value. The title property
func (m *SeriesItemSeriesGetResponse) SetTitle(value *string)() {
    m.title = value
}
// SetUpdatedAt sets the updatedAt property value. The updatedAt property
func (m *SeriesItemSeriesGetResponse) SetUpdatedAt(value *string)() {
    m.updatedAt = value
}
// SetVolume sets the volume property value. The volume property
func (m *SeriesItemSeriesGetResponse) SetVolume(value *float64)() {
    m.volume = value
}
// SetVolume24hr sets the volume24hr property value. The volume24hr property
func (m *SeriesItemSeriesGetResponse) SetVolume24hr(value *float64)() {
    m.volume24hr = value
}
type SeriesItemSeriesGetResponseable interface {
