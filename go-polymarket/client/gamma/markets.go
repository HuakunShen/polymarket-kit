...
// NewMarkets instantiates a new Markets and sets the default values.
...
// CreateMarketsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateMarketsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewMarkets(), nil
}
// GetActive gets the active property value. The active property
// returns a *bool when successful
func (m *Markets) GetActive()(*bool) {
    return m.active
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *Markets) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetClobTokenIds gets the clobTokenIds property value. The clobTokenIds property
// returns a []string when successful
func (m *Markets) GetClobTokenIds()([]string) {
    return m.clobTokenIds
}
// GetClosed gets the closed property value. The closed property
// returns a *bool when successful
func (m *Markets) GetClosed()(*bool) {
    return m.closed
}
// GetConditionId gets the conditionId property value. The conditionId property
// returns a *string when successful
func (m *Markets) GetConditionId()(*string) {
    return m.conditionId
}
// GetDescription gets the description property value. The description property
// returns a *string when successful
func (m *Markets) GetDescription()(*string) {
    return m.description
}
// GetEvents gets the events property value. The events property
// returns a []Markets_eventsable when successful
func (m *Markets) GetEvents()([]Markets_eventsable) {
    return m.events
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *Markets) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["events"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateMarkets_eventsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]Markets_eventsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(Markets_eventsable)
                }
            }
            m.SetEvents(res)
        }
...
type Marketsable interface {
    ...
    SetEvents(value []Markets_eventsable)()
