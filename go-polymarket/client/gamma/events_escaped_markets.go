...
// NewEvents_markets instantiates a new Events_markets and sets the default values.
func NewEvents_markets()(*Events_markets) {
    m := &Events_markets{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateEvents_marketsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateEvents_marketsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewEvents_markets(), nil
}
// GetActive gets the active property value. The active property
// returns a *bool when successful
func (m *Events_markets) GetActive()(*bool) {
    return m.active
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *Events_markets) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetArchived gets the archived property value. The archived property
// returns a *bool when successful
func (m *Events_markets) GetArchived()(*bool) {
    return m.archived
}
// GetBestAsk gets the bestAsk property value. The bestAsk property
// returns a *float64 when successful
func (m *Events_markets) GetBestAsk()(*float64) {
    return m.bestAsk
}
// GetBestBid gets the bestBid property value. The bestBid property
// returns a *float64 when successful
func (m *Events_markets) GetBestBid()(*float64) {
    return m.bestBid
}
// GetClobTokenIds gets the clobTokenIds property value. The clobTokenIds property
// returns a []string when successful
func (m *Events_markets) GetClobTokenIds()([]string) {
    return m.clobTokenIds
}
// GetClosed gets the closed property value. The closed property
// returns a *bool when successful
func (m *Events_markets) GetClosed()(*bool) {
    return m.closed
}
// GetCompetitive gets the competitive property value. The competitive property
// returns a *float64 when successful
func (m *Events_markets) GetCompetitive()(*float64) {
    return m.competitive
}
// GetConditionId gets the conditionId property value. The conditionId property
// returns a *string when successful
func (m *Events_markets) GetConditionId()(*string) {
    return m.conditionId
}
// GetCreatedAt gets the createdAt property value. The createdAt property
// returns a *string when successful
func (m *Events_markets) GetCreatedAt()(*string) {
    return m.createdAt
}
// GetDescription gets the description property value. The description property
// returns a *string when successful
func (m *Events_markets) GetDescription()(*string) {
    return m.description
}
// GetEnableOrderBook gets the enableOrderBook property value. The enableOrderBook property
// returns a *bool when successful
func (m *Events_markets) GetEnableOrderBook()(*bool) {
    return m.enableOrderBook
}
// GetEndDate gets the endDate property value. The endDate property
// returns a *string when successful
func (m *Events_markets) GetEndDate()(*string) {
    return m.endDate
}
// GetEndDateIso gets the endDateIso property value. The endDateIso property
// returns a *string when successful
func (m *Events_markets) GetEndDateIso()(*string) {
    return m.endDateIso
}
// GetFeatured gets the featured property value. The featured property
// returns a *bool when successful
func (m *Events_markets) GetFeatured()(*bool) {
    return m.featured
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *Events_markets) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *Events_markets) SetOneHourPriceChange(value *float64)() {
    m.oneHourPriceChange = value
}
// SetOrderMinSize sets the orderMinSize property value. The orderMinSize property
func (m *Events_markets) SetOrderMinSize(value *float64)() {
